...
public class ResponseBuilder {
    ...
    private static final String STATUS_TMPL = "HTTP/1.1 %d\n";
    private static final String HEADER_TMPL = "%s: %s\n";
...
{"status": "sucess"}
    ...
    public void write(OutputStream output) throws IOException {
        ...
        writeLine(output, String.format(STATUS_TMPL, this.status.getCode()));
        headers.forEach((key, value) -> writeLine(output, String.format(HEADER_TMPL, key, value)));
        writeLine(output, "\n");
